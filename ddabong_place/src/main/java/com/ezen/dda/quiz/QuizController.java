...
//        else {
//            sql += " feature NOT LIKE '%반려견 동반 입장 O%' AND";
//        }
...
//        else {
//            sql += " feature NOT LIKE '%주차장 O%' AND";
//        }
...
//        else {
//            sql += " feature NOT LIKE '%노트북 사용 O%' AND";
//        }
		if(sql.equals(""))
		{}
		else{sql = sql.substring(0, sql.length() - 2);}
