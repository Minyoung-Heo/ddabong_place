...
<script>
	function updateQuestionType() {
		...
		var optionsToShow = document.querySelectorAll('option[data-user-type="'
				+ userType + '"]');
...
<body>
	...
	<div class="div-container">
		<div class="category">
			<h1>Q&A</h1>
			<a href="qnaform">자주하는 질문</a><br> <a href="storeqna">업체 Q&A</a><br>
			<a href="customerqna">손님 Q&A</a><br> <a href="question"
				style="color: #ff8c00;">1:1 문의하기</a><br>
			<c:if test="${personal.id == 'admin'}">
				<a href="reply">Q&A 답변하기</a>
			</c:if>
		</div>
				...
				<table class="question" align="center">
					<tr>
						...
						<td><label><input type="radio" name="userType"
								value="손님" onclick="updateQuestionType()" checked> 손님 </label> <label><input
								type="radio" name="userType" value="업체"
								onclick="updateQuestionType()"> 업체 </label></td>
					</tr>
					<tr>
						<td>문의 유형</td>
						<td><select name="questionType">
								...
								<!-- 업체 checked일 때  -->
								<option value="회원 정보" data-user-type="업체" style="display: none;">회원
									정보</option>
								<option value="매장 정보" data-user-type="업체" style="display: none;">매장
									정보</option>
								<option value="입점 문의" data-user-type="업체" style="display: none;">입점
									문의</option>
								<option value="이용 불편사항" data-user-type="업체"
									style="display: none;">이용 불편사항</option>
					...
					<c:choose>
						...
						<c:when test="${storeloginstate == true}">
							...
							<tr>
								<td>작성자</td>
								<td><input type="text" name="writer" value="${store.ceo}"></td>
							</tr>
						</c:when>
					...
					<tr>
						<td>비밀번호</td>
						<td><input type="text" name="pw" placeholder="숫자 4자리"></td>
					</tr>
					<tr>
						<td colspan="2" style="text-align: center;"><input
							class="btn" type="button" value="입력" onclick="checkPw()"></td>
					</tr>
				</table>
			</form>
		</div>
